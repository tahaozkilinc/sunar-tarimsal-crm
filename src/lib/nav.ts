...
export const NAV_ITEMS: NavItem[] = [
  {
    ...
    roles: ["admin", "purchasing", "operations", "sales", "finans", "maliyet", "viewer", "nakliyeci", "gozetim", "acente", "sales_ops"],
  },
  {
    href: "/crm",
    label: "CRM",
  ...
  },
  {
    ...
    label: "Operasyon",
    icon: "Truck",
    roles: ["admin", "operations", "viewer", "nakliyeci", "gozetim", "acente"],
  },
  {
    href: "/inventory",
    label: "Stok",
  ...
  },
  {
    ...
    label: "Satış",
    icon: "TrendingUp",
    roles: ["admin", "sales", "viewer", "sales_ops"],
  },
  {
    href: "/finance",
    label: "Finans",
